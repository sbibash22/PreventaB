(function () {
  ...
  const el = document.getElementById("dash-chart-data");
  if (!el) {
    console.error("No chart data found (dash-chart-data).");
    return;
  }
  ...
  const rawCpu = Array.isArray(payload.cpu) ? payload.cpu : [];
  const rawRam = Array.isArray(payload.ram) ? payload.ram : [];
  const rawDisk = Array.isArray(payload.disk) ? payload.disk : [];
  ...
  const cpu = toNumberArray(rawCpu, labels.length);
  const ram = toNumberArray(rawRam, labels.length);
  const disk = toNumberArray(rawDisk, labels.length);
  ...
  function currentColors() {
    ...
    return {
      cpu: {
        line: isDark ? "rgba(96,165,250,1)" : "rgba(37,99,235,1)",
        fill: isDark ? "rgba(96,165,250,0.18)" : "rgba(37,99,235,0.12)",
      },
      ram: {
        line: isDark ? "rgba(34,197,94,1)" : "rgba(22,163,74,1)",
        fill: isDark ? "rgba(34,197,94,0.16)" : "rgba(22,163,74,0.10)",
      },
      disk: {
        line: isDark ? "rgba(251,146,60,1)" : "rgba(234,88,12,1)",
        fill: isDark ? "rgba(251,146,60,0.16)" : "rgba(234,88,12,0.10)",
      }
    };
  }
